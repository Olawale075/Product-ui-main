...
import './UserGasDashboard.css'; // ✅ Add this for extra responsive tweaks
            ...
            <Form.Group controlId="macDropdown">
              ...
              {macList.length > 0 && (
                <div className="mt-3 d-flex flex-wrap gap-2">
                  <Button
                    variant="danger"
                    onClick={() => handleDelete(selectedMac)}
                  >
                    Remove MAC
                  </Button>
                  <Button
              ...
              <Col xs={12} md={6}>
                <Card className="shadow-sm h-100">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      <strong>Location:</strong> {data.gasDetector.location}
                    </p>
                    <p>
                      <strong>Status:</strong>{' '}
                      <span
                        className={
                          data.gasDetector.status
                            ? 'text-success'
                            : 'text-danger'
                        }
                      >
                    ...
                    <p>
                      ...
                      <span
                        className={
                          data.gasDetector.temperature > 50
                            ? 'text-danger'
                            : 'text-body'
                        }
                      >
                    ...
                    <p>
                      <strong>CO2:</strong> {data.gasDetector.co2 ?? 'N/A'}
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              <Col xs={12} md={6}>
                <Card className="shadow-sm h-100">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      <strong>Phone:</strong> {data.user.phoneNumbers}
                    </p>
                    <p>
